...
class ChineseChessPiece {
  ...
  show(ctx){
    if (this.isShow) {
      ...
      ctx.drawImage(com[this.pater].img,com.spaceX * this.x + com.pointStartX , com.spaceY *  this.y +com.pointStartY);
      ctx.restore(); 
    }
  }
...
export class ChineseChessUI {
  ...
  bylaw_s(x,y,map,my){
    ...
    if (my===1){ //红方
      //4点半
      if ( y+1<= 9 && x+1<= 5 && (!this.mans[map[y+1][x+1]] || com.mans[map[y+1][x+1]].my!=my)) d.push([x+1,y+1]);
      //7点半
      if ( y+1<= 9 && x-1>= 3 && (!this.mans[map[y+1][x-1]] || com.mans[map[y+1][x-1]].my!=my)) d.push([x-1,y+1]);
      //1点半
      if ( y-1>= 7 && x+1<= 5 && (!this.mans[map[y-1][x+1]] || com.mans[map[y-1][x+1]].my!=my)) d.push([x+1,y-1]);
      //10点半
      if ( y-1>= 7 && x-1>= 3 && (!this.mans[map[y-1][x-1]] || com.mans[map[y-1][x-1]].my!=my)) d.push([x-1,y-1]);
    }else{
      //4点半
      if ( y+1<= 2 && x+1<= 5 && (!this.mans[map[y+1][x+1]] || com.mans[map[y+1][x+1]].my!=my)) d.push([x+1,y+1]);
      //7点半
      if ( y+1<= 2 && x-1>= 3 && (!this.mans[map[y+1][x-1]] || com.mans[map[y+1][x-1]].my!=my)) d.push([x-1,y+1]);
      //1点半
      if ( y-1>= 0 && x+1<= 5 && (!this.mans[map[y-1][x+1]] || com.mans[map[y-1][x+1]].my!=my)) d.push([x+1,y-1]);
      //10点半
  ...
  bylaw_j(x,y,map,my){
    ...
    if (my===1){ //红方
      ...
      //老将对老将的情况
      if ( com.mans['j0'].x == com.mans['J0'].x &&isNull) d.push([this.mans['J0'].x,com.mans["J0"].y]);
  ...
  bylaw_z(x,y,map,my){
    ...
    if (my===1){ //红方
      ...
      //右
      if ( x+1<= 8 && y<=4  && (!this.mans[map[y][x+1]] || com.mans[map[y][x+1]].my!=my)) d.push([x+1,y]);
      //左
      if ( x-1>= 0 && y<=4 && (!this.mans[map[y][x-1]] || com.mans[map[y][x-1]].my!=my))d.push([x-1,y]);
    }else{
      //下
      if ( y+1<= 9  && (!this.mans[map[y+1][x]] || com.mans[map[y+1][x]].my!=my)) d.push([x,y+1]);
      //右
      if ( x+1<= 8 && y>=6  && (!this.mans[map[y][x+1]] || com.mans[map[y][x+1]].my!=my)) d.push([x+1,y]);
      //左
      if ( x-1>= 0 && y>=6 && (!this.mans[map[y][x-1]] || com.mans[map[y][x-1]].my!=my))d.push([x-1,y]);
    }
